...
import os
import sys
sys.path.append('/data4/myt/SwinBERT')
sys.path.append('/data4/myt/SwinBERT/src/tasks')
...
def update_existing_config_for_inference(args):
    ...
    train_args.model_name_or_path = '/data4/myt/SwinBERT/models/captioning/bert-base-uncased/'
...
def VideoCaptioning(video):
    with open('/data4/myt/MovieChat/model_infer/config/SwinBERT.json') as f:
        args = DictObj(json.load(f))
    args.test_video_fname = video
    return main(args)
